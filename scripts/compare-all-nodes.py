...
from scsims import SIMS  # your model container
...
if __name__ == "__main__":
    # Load or create your model (example assumes SIMS from scsims)
    sims = SIMS(
    ...
    # For example: torch.randn(batch_size, num_features)
    # input_tensor = torch.randn(1, len(sims.model.genes))
    ...
    # onnx_path = "data/validation/encoder.onnx"
    ...
    for i in range(num_samples):
        ...
        onnx_intermediates = capture_onnx_intermediates(
            onnx_model, input_tensor[i : i + 1]
        )
