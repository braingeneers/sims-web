"""
Compare pytorch vs. onnx intermediate outputs by manually specified paths

Primarily a debugging tool to isolate differences between PyTorch and ONNX output
"""
